...
public class MainForm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainForm window = new MainForm("Espa�ol");
	...
	//TW Cen MT
	public static void crearLabel(String palabra, JPanel panel) {	//Crea un label, le asigna la palabra pasada por parametro y lo añade al panel pasado por parametro
